...
const UpdateEmailUserAds = ({ visiblePassword, dismiss,idApplicant }) => {
  ...
  const submitPassword=async()=>{
    ...
    setIsLoading(true);
    setIsError(false)
    axios.patch(`${backendURL}api/userAds/${idApplicant}`,{email:email.value})
...
export default UpdateEmailUserAds;
