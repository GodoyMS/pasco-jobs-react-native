...
const UpdateEmailCompany = ({ visiblePassword, dismiss,idApplicant }) => {
  ...
  const submitPassword=async()=>{
    ...
    setIsLoading(true);
    setIsError(false)
    axios.patch(`${backendURL}api/employers/${idApplicant}`,{email:email.value})
...
export default UpdateEmailCompany;
