...
const UpdatePasswordCompany = ({ visiblePassword, dismiss,idApplicant }) => {
  ...
  const submitPassword=async()=>{
    ...
    setIsLoading(true);
    setIsError(false)
    axios.patch(`${backendURL}api/employers/${idApplicant}`,{password})
...
export default UpdatePasswordCompany;
